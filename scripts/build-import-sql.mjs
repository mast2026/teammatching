...
const lines = [
  ...
  "begin;",
  "",
  "-- Earlier schema drafts typed these as integer/date-like fields, but the",
  "-- Replit export stores them as display strings such as 각 부문별 5팀.",
  "alter table if exists public.team_matching_contests",
  ...
  "",
  "-- The Replit export contains repeated leader applications for one member.",
  "alter table if exists public.team_matching_leader_applications",
